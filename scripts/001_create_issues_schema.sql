-- Codex Issues Visualizer Database Schema
...
-- Public read policies (no auth required for viewing)
...
CREATE POLICY "Allow public read scrape_logs" ON scrape_logs FOR SELECT USING (true);

-- Service role can do everything (for API routes)
CREATE POLICY "Service role full access sources" ON sources FOR ALL USING (true);
CREATE POLICY "Service role full access categories" ON categories FOR ALL USING (true);
CREATE POLICY "Service role full access issues" ON issues FOR ALL USING (true);
CREATE POLICY "Service role full access scrape_logs" ON scrape_logs FOR ALL USING (true);
