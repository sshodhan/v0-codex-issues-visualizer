...
export async function GET(request: NextRequest) {
  ...
  const { data, error } = await supabase
    ...
    .select(
      "observation_id, category_slug, error_code, top_stack_frame, cli_version, fp_os, fp_shell, fp_editor, model_id, llm_category, llm_subcategory, llm_primary_tag, llm_confidence, llm_review_status",
    )
